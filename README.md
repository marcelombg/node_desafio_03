...
[OK] Deve ser possível se cadastrar como uma ONG
[OK] Deve ser possível realizar login como uma ONG

### Regras de negócio
[OK] Para listar os pets, obrigatoriamente precisamos informar a cidade
[OK] Uma ONG precisa ter um endereço e um número de WhatsApp
